...
var pausing_function = function handler(e) {  
        ...
        if(e.target.currentTime >= 1 * 60) {
            ...
            currentVideoTime1 = e.target.currentTime;
            console.log('saving part1 currentVideoTime ', currentVideoTime1);
...
var pausing2_function = function handler(e) {  
         ...
         if(e.target.currentTime >= 3 * 60) {
            ...
            currentVideoTime1 = e.target.currentTime;
            console.log('saving part2 currentVideoTime ', currentVideoTime1);
    ...
    var pausing3_function = function handler(e) {  
        ...
        if(e.target.currentTime >= 5 * 60) {
            ...
            currentVideoTime1 = e.target.currentTime;
            console.log('saving part3 currentVideoTime ', currentVideoTime1);
...
function skipTheAd() { 
  ...
  function resume() { 
    ...
    console.log('Play Main Video from Paused location ' , currentVideoTime1);

    AdHidden();

    myvideo.currentTime = currentVideoTime1;
    myvideo.load();
    myvideo.play();
